<?php
    class HTMLAdmin{
        ...
        public static function menuGroup()
        {
            $xhtml = '
            <div class="card-body">
            <form action="'.URL::createLink('admin','group','multydelete').'" method="POST" id="formList">
        ...
        public static function menuUser()
        {
            ...
            $xhtml = '
             <div class="card-body">
            <form action="'.URL::createLink('admin','user','multydelete').'" method="POST" id="formList">
			<table class=" table table-striped">
	            <thead>
                    <tr>
                        <th style="width: 3%">
        ...
        public static function menuCategory()
        {
            $xhtml = '
            <div class="card-body">
            <form action="'.URL::createLink('admin','category','multydelete').'" method="POST" id="formList">
			<table class="table table-striped">
				<thead>
					<tr>
						<th style="width: 5%">
        ...
        public static function menuBook()
        {
            $xhtml = '
            <div class="card-body">
            <form action="'.URL::createLink('admin','book','multydelete').'" method="POST" id="formList">
			<table class="table table-striped">
				<thead>
					<tr>
						<th style="width: 1%">
