			...
			<div class="container">
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
						<div class="single-banner">
							<div class="banner-img">
								<a href="#"><img src="<?php echo $this->_dirImg.'/banner/1.png'?>" alt="banner" /></a>
							</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
						<div class="single-banner">
							<div class="banner-img">
								<a href="#"><img src="<?php echo $this->_dirImg.'/banner/2.png'?>" alt="banner" /></a>
							</div>
							<div class="banner-text">
					...
					<div class="col-lg-3 col-md-3 hidden-sm col-xs-12">
						<div class="single-banner">
							<div class="banner-img">
								<a href="#"><img src="<?php echo $this->_dirImg.'/banner/3.png'?>" alt="banner" /></a>
							</div>
							<div class="banner-text">
					...
					<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
						<div class="single-banner mrg-none-xs">
							<div class="banner-img">
								<a href="#"><img src="<?php echo $this->_dirImg.'/banner/4.png'?>" alt="banner" /></a>
							</div>
							<div class="banner-text">
								<h4>Help & Support</h4>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
						...
						<div class="banner-img-2">
							<a href="#"><img src="<?php echo $this->_dirImg.'/banner/6.jpg'?>" alt="banner" /></a>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="bestseller-active owl-carousel">
							<div class="bestseller-total">
								<div class="single-bestseller mb-25">
									<div class="bestseller-img">
										<a href="#"><img src="<?php echo $this->_dirImg.'/product/13.jpg'?>" alt="book" /></a>
										<div class="product-flag">
                                            <ul>
                                                <li><span class="sale">new</span></li>
                                                <li><span class="discount-percentage">-5%</span></li>
								...
								<div class="single-bestseller">
									<div class="bestseller-img">
										<a href="#"><img src="<?php echo $this->_dirImg.'/product/14.jpg'?>" alt="book" /></a>
										<div class="product-flag">
                                            <ul>
                                                <li><span class="sale">new</span></li>
                                            </ul>
							...
							<div class="bestseller-total">
								<div class="single-bestseller mb-25">
									<div class="bestseller-img">
										<a href="#"><img src="<?php echo $this->_dirImg.'/product/15.jpg'?>" alt="book" /></a>
										<div class="product-flag">
                                            <ul>
                                                <li><span class="sale">new</span></li>
                                            </ul>
								...
								<div class="single-bestseller">
									<div class="bestseller-img">
										<a href="#"><img src="<?php echo $this->_dirImg.'/product/16.jpg'?>" alt="book" /></a>
										<div class="product-flag">
                                            <ul>
                                                <li><span class="sale">new</span></li>
                                                <li><span class="discount-percentage">-5%</span></li>
							...
							<div class="bestseller-total">
								<div class="single-bestseller mb-25">
									<div class="bestseller-img">
										<a href="#"><img src="<?php echo $this->_dirImg.'/product/17.jpg'?>" alt="book" /></a>
										<div class="product-flag">
                                            <ul>
                                                <li><span class="sale">new</span></li>
                                            </ul>
