							...
							<div class="row">
								<div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
									<div class="flexslider">
										<ul class="slides">
											<li data-thumb="<?php echo $this->_dirImg .'/thum-2/1.jpg' ?>">
											  <img src="<?php echo $this->_dirImg .'/flex/1.jpg" alt="woman' ?>" />
											</li>
											<li data-thumb="<?php echo $this->_dirImg .'/thum-2/4.jpg'?>">
											  <img src="<?php echo $this->_dirImg .'/flex/5.jpg'?>" alt="woman" />
											</li>
											<li data-thumb="<?php echo $this->_dirImg .'/thum-2/2.jpg'?>">
											  <img src="<?php echo $this->_dirImg .'/flex/2.jpg" alt="woman'?>" />
											</li>
											<li data-thumb="<?php echo $this->_dirImg .'/thum-2/5.jpg'?>">
											  <img src="<?php echo $this->_dirImg.'/flex/5.jpg'?>" alt="woman" />
											</li>
										</ul>
									</div>
