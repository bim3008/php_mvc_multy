                ...
                <form action="<?php echo $linkSubmit;?>" method="POST" id="userchange">
                    <fieldset>
                        ...
                        <div class="single-input-item">
                            ...
                            <input type="password" name="form[old-pass]" placeholder="<?php echo ENTER_PASSOLD ?>">
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="single-input-item">
                                    <label for="new-pwd" class="required">Mật khẩu mới</label>
                                    <input type="password" name="form[new-pass]" placeholder="<?php echo ENTER_PASSNEW ?>">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="single-input-item">
                                    <label for="confirm-pwd" class="required">Nhập lại mật khẩu</label>
                                    <input type="password"  name="form[re-pass]" placeholder="<?php echo ENTER_PASSRE ?>">
